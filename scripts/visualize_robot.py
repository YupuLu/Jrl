...
python scripts/visualize_robot.py --robot_name=ur3
python scripts/visualize_robot.py --robot_name=ur3e
python scripts/visualize_robot.py --robot_name=ur5e
python scripts/visualize_robot.py --robot_name=ur10
python scripts/visualize_robot.py --robot_name=ur10e
python scripts/visualize_robot.py --robot_name=ur16e
